  ...
  useEffect(() => {
    const initializeAuth = async () => {
      try {
        ...
        console.log('DashboardLayout: Local user session:', localUser);
        
        if (localUser && LocalAuthService.isValidSession(localUser)) {
          console.log('DashboardLayout: Valid local session found, setting user');
          setUser(localUser);
          setLoading(false);
          return;
        } else {
          console.log('DashboardLayout: No valid local session, checking Supabase...');
        }
        ...
        if (!session) {
          console.log('DashboardLayout: No Supabase session, redirecting to login');
          router.push('/login');
        } else {
          console.log('DashboardLayout: Supabase session found, setting user');
          setUser(session.user);
        }
      } catch (error) {
